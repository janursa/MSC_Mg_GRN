...
class LegendPlot():
    """
    The main class to create the legend used in the network visualization
    """
    title_size = 9
    size = 10
    @staticmethod
...
def create_nodes_edges(links, gene_names) -> Tuple[pd.DataFrame, pd.DataFrame]:
    ...
    nodes, edges = add_centrality(nodes, edges)

    return nodes, edges

def add_centrality(nodes, edges):
