...
from proteomics_MSC.imports import DATA_DIR
from proteomics_MSC.common_tools import F_DE_protnames, flatten
...
if __name__ == '__main__':
    protnames = flatten(F_DE_protnames().values())
    map_protnames_genenames = protname_genename(protnames)
    with open(Path(DATA_DIR)/ 'protnames_to_genenames.json', 'w') as ff:
        json.dump(map_protnames_genenames, ff)
    print(f'output -> {DATA_DIR}/protnames_to_genenames.json')