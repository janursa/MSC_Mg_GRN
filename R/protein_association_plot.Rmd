...
for (DE_type in list('early_MinProb','late_KNN')){
  for (term in list('process','function','component')){
    ...
    base_asp = 1.1
    circular = TRUE
    if (DE_type == 'late_KNN' & term == 'function'){
      base_height = 8
    }
    if (DE_type == 'late_KNN' & term == 'process'){
      base_height = 6
    }
    if (DE_type == 'late_KNN' & term == 'component'){
      base_height = 4
      circular = FALSE
    }
    if (DE_type == 'early_MinProb' & term == 'function'){
      base_height = 6
    }
    if (DE_type == 'early_MinProb' & term == 'process'){
      base_height = 5
    }
    if (DE_type == 'early_MinProb' & term == 'component'){
      base_height = 4
      circular = FALSE
    }
