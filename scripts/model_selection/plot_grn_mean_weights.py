...
if __name__ == '__main__':
    ...
    for DE_type, _ in F_DE_protiens().items():
        for method in methods:
            ...
            plot_mean_weights(axes[model_i], links_stack, make_title_pretty(model_name), studies)
            model_i+=1
    fig.savefig(os.path.join(MODELSELECTION_DIR, f'mean_weights.pdf'))
    fig.savefig(os.path.join(MODELSELECTION_DIR, f'mean_weights.png'), dpi=300, transparent=True)
