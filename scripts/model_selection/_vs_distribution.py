...
from scripts.imports import MODELSELECTION_DIR, GRN_DIR, ENRICH_DIR, F_DE_data
...
if __name__ == '__main__':
    ...
    for top_quantile in [.75, .9]: #one plot for each
        ...
        fig.savefig(os.path.join(MODELSELECTION_DIR, f'match_count_{top_quantile}.png'), dpi=300, transparent=True)
        fig.savefig(os.path.join(MODELSELECTION_DIR, f'match_count_{top_quantile}.pdf'))
