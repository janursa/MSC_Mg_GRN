...
if __name__ == '__main__':
    ...
    fig.savefig(os.path.join(MODELSELECTION_DIR, f'mc_trends_method.png'), dpi=300, transparent=True)
    fig.savefig(os.path.join(MODELSELECTION_DIR, f'mc_trends_method.pdf'))
