...
if __name__ == '__main__':
    ...
    fig.savefig(os.path.join(VS_STRING_DIR, f'match_count_trends.png'), dpi=300, transparent=True)
    fig.savefig(os.path.join(VS_STRING_DIR, f'match_count_trends.pdf'))
