...
from scripts.imports import ENRICH_DIR, VS_STRING_DIR, F_DE_data, GRN_DIR, F_DE_protiens
...
if __name__ == '__main__':
    ...
    fig_pr.savefig(os.path.join(VS_STRING_DIR, f'precision_recall.pdf'))
    fig_roc.savefig(os.path.join(VS_STRING_DIR, f'roc.pdf'))
