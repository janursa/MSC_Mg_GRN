...
from common_tools import process_data
from common_tools.enrich_analysis import string_network_analysis
from imports import top_quantiles, F_selected_models
from common_tools.model_selection import calculate_early_precision
from rr_aux import save_random_scores
...
if __name__ == '__main__':
    ...
    for selected_model in selected_models:
        ...
        save_random_scores(selected_model, ep_score_stack)
