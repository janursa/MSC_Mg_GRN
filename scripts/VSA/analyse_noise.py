...
from imports import F_model_name_2_method_and_DE_type, VSA_DIR, F_DE_genenames, CALIBRATION_DIR, time_points, F_selected_models, VSA_NOISE_DIR
    ...
    for model_name in selected_models:
        ...
        run_noise_analysis_F = lambda noise_type, noise_stds: run_noise_analysis (noise_type=noise_type, stds_noise=noise_stds, data_ctr=data_studies[0], data_sample=data_studies[1], n_noisy_datasets=n_noisy_datasets,
                      warm_start=warm_start,
                       model_name=model_name, gene_names=genenames, target_genes=target_genes, method=method, DE_type=DE_type, noise_runs_dir=VSA_NOISE_RUNS_DIR)
