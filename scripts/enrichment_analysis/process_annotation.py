...
from imports import *
from enrichment_analysis import annotaion_map
...
if __name__ == '__main__':
    ...
    with open(os.path.join(OUTPUT_DIR, 'data', 'DE_protnames.txt')) as f:
    ...
    with open(os.path.join(OUTPUT_DIR, 'data', 'map_genename_protname.json'), 'w') as f:
