...
from imports import time_points, protnames, MAIN_DIR, df_target, GRN_DIR
...
if __name__ == '__main__':
    ...
    for study in ['ctr', 'mg']:
        data = process_data(df_target, study='ctr', time_points=time_points(), standardize=False)
